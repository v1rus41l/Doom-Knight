...
while True:
    ...
    def main():
        global is_jump, wasd_cfg, defolt_cfg, action, check_of_fall1, check_of_fall_12, check_of_fall_13, falling, running, score, knight, vector, gameover, youwin, WIDTH, HEIGHT
        pygame.init()
        is_jump = False
        action = False
        check_of_fall1 = True
